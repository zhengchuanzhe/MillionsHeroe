...
public class MainActivity extends AppCompatActivity {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch (radioGroup.getCheckedRadioButtonId()){
                    case R.id.chong_ding:
                        mSize = new int[]{Util.dp2px(MainActivity.this, 190),Util.dp2px(MainActivity.this, 300)};
                        break;
                    case R.id.baiwan:
                        mSize = new int[]{Util.dp2px(MainActivity.this, 100),Util.dp2px(MainActivity.this, 300)};
                        break;
                    case R.id.zhishi:
                        mSize = new int[]{Util.dp2px(MainActivity.this, 100),Util.dp2px(MainActivity.this, 300)};
                        break;
    ...
    private void checkPhonePermissions() {
        //使用兼容库就无需判断系统版本
        int hasPhonePermissions = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_NETWORK_STATE);
